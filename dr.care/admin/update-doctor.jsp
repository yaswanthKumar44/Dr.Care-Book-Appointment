...
<%
    try {
        ...
        String query = "UPDATE doctors SET DOCTOR_NAME=?, GENDER=?, SPECIALIST=?, EXPERIENCE=?, AVAILABILITY_STATUS=?, DATE_OF_LEAVE1=?, DATE_OF_LEAVE2=?, DATE_OF_LEAVE3=?, EMAIL=?, MOBILE=?, AGE=?, PASSWORD=? WHERE DOCTOR_ID=?";
